...
"""Regression checks for closure search orchestration guards.

Run:
  python nestynet_sr/sr_search/factorized_search/smoke_closure_search_orchestration_guards.py
"""
import sys
...
from nestynet_sr.sr_search.factorized_search.proposal_families.runner import run_closure_search_pass_impl
...
def _run_execution(candidate_rows, *, exact_topk):
    ...
    run_closure_search_pass(
        ...
        closure_search_exact_topk=int(exact_topk),
        closure_search_min_valid_frac=0.0,
        closure_search_min_confidence=0.0,
        ...
        run_closure_search_pass_impl=fake_pass_impl,
