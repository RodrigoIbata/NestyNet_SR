...
def run_repair_slate_training(
    *,
    ...
    summary = {
        ...
        "repair_slate_ranker_target": str(bundle.get("repair_slate_ranker_target", "")),
        "repair_slate_action_names": list(bundle.get("repair_slate_action_names", []) or []),
...
def main() -> None:
    ...
    p.add_argument("--path_ce_weight", type=float, default=0.20)
    p.add_argument("--route_aux_weight", type=float, default=0.10)
    p.add_argument("--value_weight", type=float, default=0.10)
