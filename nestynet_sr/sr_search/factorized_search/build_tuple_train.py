...
def run_build_tuple_training(
    *,
    ...
    sample_pred = None
    for row in rows:
        pred = predict_build_tuple_slate(bundle, row)
    ...
    summary = {
        ...
        "build_tuple_ranker_target": str(bundle.get("build_tuple_ranker_target", "")),
        "build_tuple_ranker_score_gap_floor": float(bundle.get("build_tuple_ranker_score_gap_floor", 0.0) or 0.0),
        "build_tuple_ranker_state_value_weight": float(bundle.get("build_tuple_ranker_state_value_weight", 0.0) or 0.0),
